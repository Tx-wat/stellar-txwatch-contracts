...
impl AlertRegistry {
    ...
    /// Return the total number of alerts ever registered.
    ///
    /// This is a monotonically increasing counter and is **not** decremented
    /// when alerts are removed. It reflects the next ID that will be assigned.
